...
// TESTS D'AJOUT D'UNE ÉVALUATION
    ...
    void addEvaluation_shouldSaveEvaluationWithAuthor() {
        ...
        EvaluationDto dto = new EvaluationDto(1L, author, "Très bon !", 3, null);
...
// TESTS DE RECHERCHE D'ÉVALUATIONS PAR AUTEUR
    ...
    void getEvaluationsByAuthor_shouldReturnListFromRepository() {
        ...
        EvaluationDto dto1 = new EvaluationDto(1L, author, "Super resto", 3, null);
        EvaluationDto dto2 = new EvaluationDto(1L, author, "À éviter", 0, null);
